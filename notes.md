...
![image-20260401221844578](../../AppData/Roaming/Typora/typora-user-images/image-20260401221844578.png)

确实，单循环链表是不可能为空的，只能通过是否走一圈最后到达这个头来判断

![image-20260401223803057](../../AppData/Roaming/Typora/typora-user-images/image-20260401223803057.png)

如果只有一个头结点的话，是可以判断为空的，判断他的这个next是否指向自己即可

![image-20260401224418200](../../AppData/Roaming/Typora/typora-user-images/image-20260401224418200.png)

存储一个数据，该数据所占据的空间，和存储这个数据所占据的总空间的比值，就是这个存储密度

![image-20260401230250573](../../AppData/Roaming/Typora/typora-user-images/image-20260401230250573.png)

始终领先K步，真是有意思，并且引入这个pre指针进行最后的删除吗，真是有意思

![image-20260402151155070](../../AppData/Roaming/Typora/typora-user-images/image-20260402151155070.png)

将这个头的下一个节点给这个P节点了，P成为头节点了

![image-20260410103343928](../../AppData/Roaming/Typora/typora-user-images/image-20260410103343928.png)



其实这个很有意思，如果前面的比后面的大，那会先弹出前面的，然后运算，然后再压入后面的，然后再压入这个参数

![image-20260410104153387](../../AppData/Roaming/Typora/typora-user-images/image-20260410104153387.png)

从逻辑上，从运算级的优先级上面来看，确实是这样操作的，但是![image-20260410104353383](../../AppData/Roaming/Typora/typora-user-images/image-20260410104353383.png)

过程是非常清晰的，那么该如何使用这个算法去实现呢

![image-20260410104746178](../../AppData/Roaming/Typora/typora-user-images/image-20260410104746178.png)

确实，从左向右压栈，那么从右像左弹出

![image-20260410105458936](../../AppData/Roaming/Typora/typora-user-images/image-20260410105458936.png)

先弹出两个操作数，然后进行这个计算，最后压回栈





你能感觉到什么，这个数的所有操作中，一切皆递归，同时你要注意一个点，这个递归和那个归纳法求解简直神同

![image-20260513202302194](../../AppData/Roaming/Typora/typora-user-images/image-20260513202302194.png)

这个队列是先出队，然后再依次的访问

![image-20260513202745975](../../AppData/Roaming/Typora/typora-user-images/image-20260513202745975.png)

这个递归的过程这个，通过实际的栈递归的过程竟然是这个根右左

对应这个正常使用函数递归的根左右

![image-20260513203359769](../../AppData/Roaming/Typora/typora-user-images/image-20260513203359769.png)

有意思这个非递归后序遍历，竟然使用两个栈去完成，精彩，多出来的那个栈用来记录这个左右已经访问完成，之后才能够对这个中间的节点进行这个访问

![image-20260513203955468](../../AppData/Roaming/Typora/typora-user-images/image-20260513203955468.png)

好一个左子树和这个右子树的最大值加上一个1，这个本质依旧是这个递归的思想，很深刻

![image-20260513204150492](../../AppData/Roaming/Typora/typora-user-images/image-20260513204150492.png)

深度，左右节点数量，以及这个叶子节点的数量，全部可以使用这个递归进行完成

![image-20260513204834269](../../AppData/Roaming/Typora/typora-user-images/image-20260513204834269.png)

每找到一个节点，都将他的这个左右子树交换一下子，然后向这个左边递归，然后继续左边递归，然后弹出返回，然后右边递归，返回返回返回

![image-20260513210341072](../../AppData/Roaming/Typora/typora-user-images/image-20260513210341072.png)

有意思，分批次处理

![image-20260513210822404](../../AppData/Roaming/Typora/typora-user-images/image-20260513210822404.png)
有意思，不停地递归，直到遇到这个叶子，然后计算这个长度，否则继续后移
