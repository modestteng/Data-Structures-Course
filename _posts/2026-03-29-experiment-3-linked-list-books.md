...
把实验 1 的顺序表换成带头/尾指针的单链表实现，体会节点分配、链式遍历、头插与尾插的差异。
...
```powershell
gcc -finput-charset=UTF-8 -fexec-charset=UTF-8 homework/experiment_3.c -o homework/experiment_3.exe
.\homework\experiment_3.exe
```
