...
在实验 1 的顺序表上加菜单驱动入口、输入校验、容量检查，把零散操作整合成一个可交互的小系统。
...
```powershell
gcc -finput-charset=UTF-8 -fexec-charset=UTF-8 homework/experiment_2.c -o homework/experiment_2.exe
.\homework\experiment_2.exe
```
