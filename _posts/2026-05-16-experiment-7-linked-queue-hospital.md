...
链式队列模拟医院叫号：按到达时间入队、按治疗时间出队，统计平均等待与平均处理时间。
...
```powershell
gcc -finput-charset=UTF-8 -fexec-charset=UTF-8 homework/experiment_7.c -o homework/experiment_7.exe
.\homework\experiment_7.exe
```
