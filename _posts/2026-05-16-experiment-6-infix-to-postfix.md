...
双栈实现表达式处理：一个栈处理运算符优先级把中缀转为后缀，另一个数字栈完成最终求值。
...
```powershell
gcc -finput-charset=UTF-8 -fexec-charset=UTF-8 homework/experiment_6.c -o homework/experiment_6.exe
.\homework\experiment_6.exe
```
