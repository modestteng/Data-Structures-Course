...
时间片轮转作业调度：作业按到达时间入队，每次取一个时间片执行；没做完就重新排到队尾，最终统计平均周转/等待时间。
...
```powershell
gcc -finput-charset=UTF-8 -fexec-charset=UTF-8 homework/experiment_8.c -o homework/experiment_8.exe
.\homework\experiment_8.exe
```
