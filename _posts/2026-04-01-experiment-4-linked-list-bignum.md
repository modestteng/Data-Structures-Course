...
用单链表保存任意位长的整数：每个节点存一位，演示字符串到链表的尾插构造，便于做加法/比较等大数运算。
...
```powershell
gcc -finput-charset=UTF-8 -fexec-charset=UTF-8 homework/experiment_4.c -o homework/experiment_4.exe
.\homework\experiment_4.exe
```
