...
字符串操作演示系统：用串头表（串名/串首并行数组）管理多个串，支持按命令名解析、参数分发与多串协同操作。
...
```powershell
gcc -finput-charset=UTF-8 -fexec-charset=UTF-8 homework/experiment_10.c -o homework/experiment_10.exe
.\homework\experiment_10.exe
```
